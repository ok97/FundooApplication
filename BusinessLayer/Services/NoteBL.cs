...
namespace BusinessLayer.Services
{
    public class NoteBL : INoteBL
    {
        ...
        {
            bool responseData = noteRL.TrashNote(userId, noteID);
            return responseData;
        }
        //Put Archive Note
        public bool ArchievedUnarchievedNote(int userID, int noteID)
        {
            bool responseData = noteRL.ArchievedUnarchievedNote(userID, noteID);
            return responseData;
        }
        ...
        {
            bool responseData = noteRL.PinUnpinNote(userID, noteID);
            return responseData;
        }
